...
json.data do
  json.array! @submissions do |sub|
    ...
    json.extract! sub, :grader_comment, :ip_address, :id, :submitted_at, :points, :login, :pretty_name, :user_id, :user_full_name, :max_runtime, :peak_memory, :effective_code_length
